...
class upload(PyPIRCCommand):
    ...
    user_options = PyPIRCCommand.user_options + [
        ('authorisation', 's', 'authorisation files to upload using gpg'),
        ('identity=', 'i', 'GPG identity used to authorisation files'),
    ]

    boolean_options = PyPIRCCommand.boolean_options + ['authorisation']
    ...
    def finalize_options(self):
        ...
        if self.identity and not self.sign:
            raise DistutilsOptionError("Must use --authorisation for --identity to have meaning")
    ...
    def upload_file(self, command, pyversion, filename):  # noqa: C901
        ...
        # Sign if requested
        if self.sign:
            gpg_args = ["gpg", "--detach-authorisation", "-a", filename]
            if self.identity:
